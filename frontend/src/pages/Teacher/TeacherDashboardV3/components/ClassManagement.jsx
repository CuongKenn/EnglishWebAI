...
export default function ClassManagement() {
  ...
  const handleAddStudent = async () => {
    ...
    try {
      ...
      alert(error.response?.data?.detail || 'Lỗi khi thêm học sinh! Kiểm tra email đã đúng và user đã tồn tại chưa.');
    } finally {
      setLoading(false);
    }
  };
        ...
        <div className="class-modal-body">
          <div className="form-group-class">
            ...
            <small style={{color: '#666', fontSize: '12px'}}>
              Nhập email của tài khoản học sinh đã đăng ký trong hệ thống
            </small>
          </div>
        </div>
      ...
      <div className="info-box-class">
        ...
        <div className="info-content-class">
          ...
          <ul>
            ...
            <li><strong>Xóa học sinh:</strong> Click icon 🗑️ bên cạnh tên học sinh để gỡ khỏi lớp</li>
