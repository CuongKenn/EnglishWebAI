...
from app.schemas.system_config import SystemConfigCreate, SystemConfigUpdate, SystemSettingsOut, SystemSettingsUpdate
...
class SystemConfigService:
    ...
    @staticmethod
    def get_config_by_key(db: Session, key: str) -> SystemConfig | None:
    ...
    def get_all_configs(db: Session, public_only: bool = False) -> list[SystemConfig]:
        ...
        if public_only:
            query = query.filter(SystemConfig.is_public)
        return query.all()
    ...
    @staticmethod
    def update_config(db: Session, key: str, config_data: SystemConfigUpdate) -> SystemConfig | None:
