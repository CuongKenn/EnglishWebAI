...
from app.routers import (
    ...
    exam_assessments,
    # exam_proctoring,  # Temporarily disabled - requires torch
    exercises,
    exports,
    # face_verification,  # Temporarily disabled - requires torch
    lesson_plans,
    lessons,
    materials,
    media,
...
app.include_router(chat_room.router, prefix=f"{settings.API_PREFIX}/chat", tags=["Chat Room"])
app.include_router(ai_virtual_room.router, prefix=f"{settings.API_PREFIX}/ai-virtual-room", tags=["AI Virtual Room"])
...
# app.include_router(exam_proctoring.router, prefix=f"{settings.API_PREFIX}/proctoring", tags=["Exam Proctoring"])  # Disabled - requires torch
...
# app.include_router(face_verification.router, prefix=f"{settings.API_PREFIX}/face", tags=["Face Verification"])  # Disabled - requires torch
